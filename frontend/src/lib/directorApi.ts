...
export const MOCK_SCENE_4_COVERAGE: DirectorCoveragePlan = {
  ...
  triage: {
    tiers: {
      "1": { shots: 4, cost: 0.60, ids: ["shot_04_01", "shot_04_02", "shot_04_04", "shot_04_07"] },
      "2": { shots: 2, cost: 2.65, ids: ["shot_04_03", "shot_04_06"] },
      "3": { shots: 1, cost: 0.15, ids: ["shot_04_05"] },
    },
    needs_review: ["shot_04_03", "shot_04_05", "shot_04_06"],
  },
  coverage: [
    {
      id: "shot_04_01",
      ...
      shot_number: "04.01",
      tier: 1,
      tier_reason: "Standard parallax shot ($0.15 draft image)",
    ...
    },
    {
      ...
      shot_number: "04.02",
      tier: 1,
      tier_reason: "Standard static macro insert ($0.15 draft image)",
      purpose: "detail",
    ...
    },
    {
      ...
      shot_number: "04.03",
      tier: 2,
      tier_reason: "Paid AI video model (seedance_2_0)",
      purpose: "master",
      subject: "MASTER_PASS",
      shot_size: "ws",
      angle: "three_quarter",
    ...
    },
    {
      ...
      shot_number: "04.04",
      tier: 1,
      tier_reason: "Standard parallax document insert ($0.15 draft image)",
      purpose: "insert",
    ...
    },
    {
      ...
      shot_number: "04.05",
      tier: 3,
      tier_reason: "Identity-critical character close-up (Heney face anchor)",
      purpose: "reaction",
      subject: "HENEY_01",
      shot_size: "cu",
      angle: "ots",
    ...
    },
    {
      ...
      shot_number: "04.07",
      tier: 1,
      tier_reason: "Standard parallax labor cutaway ($0.15 draft image)",
      purpose: "cutaway",
